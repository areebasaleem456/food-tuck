...
const Signup = () => {
  return (
    ...
    <div className='h-auto bg-white p-6 max-w-lg mx-auto shadow-lg rounded-lg'>
       <h1 className="text-3xl font-semibold text-gray-700 mb-6 text-center">Sign Up</h1>
       ...
       <button className='w-full bg-orange-700 text-white h-10 md:w-full rounded-md shadow-md hover:bg-orange-800 transition duration-300 mb-4 mt-4'>Sign Up</button>
